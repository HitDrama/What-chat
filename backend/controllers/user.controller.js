...
export const register = async (req, res) => {
    try {
        ...
        await User.create({
            ...
            profilePicture: "https://unsplash.com/photos/smiling-man-standing-near-green-tree-MTZTGvDsHFY",
        });
...
export const login = async (req, res) => {
    try {
        ...
        // điền vào mỗi bài đăng trong mảng bài đăng
...
export const followOrUnfollow = async (req, res) => {
    try {
        const currentUserId = req.id; // nguoi hien dang thuc hien action (follow/unfollow)
        const targetUserId = req.params.id; // nguoi duoc follow/unfollow
